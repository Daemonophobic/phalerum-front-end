  ...
  return (
    <div className="flex items-center">
      <div className="flex-shrink-0 h-10 w-10">
        <img className="h-10 w-10 rounded-full" onError={defaultSrc} src={`/img/${props.user.profilePicture ? props.user.profilePicture : 'default.jpg'}`} alt={props.user.emailAddress} />
      </div>
      <div className="ml-4">
